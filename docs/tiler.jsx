...
var FolderPath = "v:/tmp/maptest/";  //<-- path to where we will save our tiles
...
var OrgZoomLevel = 0;   // the Google Maps zoom level of your Photoshop document (for best results, you will need to resize your  Photoshop document to match a zoom level as closely as possible before running this script)
